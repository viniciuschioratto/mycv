...
describe('UsersController', () => {
  ...
  beforeEach(async () => {
    fakeUsersService = {
      findOne:  (id: number) => {
        return Promise.resolve({id, email: 'asdf@asdf.com', password: 'asd'} as User)
      },
      find:  (email: string) => {
  ...
  it('findAllUsers returns a list of users with the given enail', async () => {
  ...
  it('finUser returns a single user with the given id', async () => {
  ...
  it('signin updates session objetc and returns user', async () => {
